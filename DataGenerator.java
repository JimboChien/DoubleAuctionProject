...
public class DataGenerator {
    ...
    public DataGenerator(int sellerAmount, int buyerAmount, double gridPrice, double sellAmountCeil, double sellAmountFloor, double sellPriceCeil, double sellPriceFloor, double buyAmountCeil, double buyAmountFloor, double buyPriceCeil, double buyPriceFloor) {
    ...
    private void generate() {
        ...
        for (int i = 0; i < sellers.length; i++) {
            sellers[i] = new Users("Seller", i, randomValue(sellAmountFloor, sellAmountCeil), randomValue(sellPriceFloor, sellPriceCeil));
        }
        
        for (int i = 0; i < buyers.length; i++) {
            buyers[i] = new Users("Buyer", i, randomValue(buyAmountFloor, buyAmountCeil), randomValue(buyPriceFloor, buyPriceCeil));
        }
    }
